...
SECRET_KEY = config('SECRET_KEY', default='django-build-secret-key-change-in-production-12345678901234567890123456')
...
MIDDLEWARE = [
    ...
    'blog_backend.middleware.PerformanceMiddleware',  # Performance monitoring
...
# Database Configuration - Using SQLite for Django and MongoDB for data storage
DATABASES = {
    'default': {
